  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 pt-4 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto w-1/2 flex justify-center">
        <nav className="relative rounded-full bg-white/8 backdrop-blur-2xl shadow-lg shadow-black/5 px-6 py-2 w-full overflow-hidden">
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="absolute top-full left-0 right-0 mt-2 rounded-2xl bg-white/8 backdrop-blur-2xl shadow-lg shadow-black/5 overflow-hidden">
